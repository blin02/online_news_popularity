  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "plots",
              tabsetPanel(type = "tabs", 
                          tabPanel("Hot", 
                                   radioButtons("hotSelection", label = "Select Topics, Titles", inline = TRUE,
                                                      choices = list("Topic" = "topic", "Title" = "title"),
                                                      selected = "topic"),
                                   fluidRow(
                                     box(
                                     ...
                                     box(
                                       width = 4, status = "info",
                                       title = "Hot Words",
                                       DT::dataTableOutput("table_word_count")
                          ...
                          tabPanel("Authors", 
                                   ...
                                   #plotOutput('plot_author_by_shares')
                          ),
                          tabPanel("Shares",
